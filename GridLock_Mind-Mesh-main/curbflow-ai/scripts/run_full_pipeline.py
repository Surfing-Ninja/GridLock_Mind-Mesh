...
def _run_deep_training(enabled: bool) -> bool:
    ...
    if not enabled:
        ...
        return False
    from run_train_deep import _load_training_config as load_deep_training_config  # noqa: PLC0415
    from curbflow.ml.be_sthgt.trainer import train_be_sthgt  # noqa: PLC0415
...
def _run_ranker_training(enabled: bool, *, use_deep_predictions: bool, fast_demo: bool) -> bool:
    ...
    if not enabled:
        ...
        return False
    from run_train_ranker import _load_ranker_config as load_ranker_config, _with_overrides as ranker_config_with_overrides  # noqa: PLC0415
